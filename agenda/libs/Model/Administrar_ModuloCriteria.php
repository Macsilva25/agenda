...
require_once("DAO/Administrar_ModuloCriteriaDAO.php");

/**
 * The Administrar_ModuloCriteria class extends Administrar_ModuloDAOCriteria and is used
 ...
 * @version 1.0
 */
class Administrar_ModuloCriteria extends Administrar_ModuloCriteriaDAO
{
