...
require_once("DAO/Agenda_TelefonicaCriteriaDAO.php");

/**
 * The Agenda_TelefonicaCriteria class extends Agenda_TelefonicaDAOCriteria and is used
 ...
 * @version 1.0
 */
class Agenda_TelefonicaCriteria extends Agenda_TelefonicaCriteriaDAO
{
