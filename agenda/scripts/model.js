/**
 * backbone model definitions for Agenda Telefonica
 */
...
/**
 * Administrar_Funcionalidade Backbone Model
 */
model.Administrar_FuncionalidadeModel = Backbone.Model.extend({
	urlRoot: 'api/administrar_funcionalidade',
	idAttribute: 'id',
	id: '',
	idModulo: '',
	descricao: '',
...
/**
 * Administrar_Funcionalidade Backbone Collection
 */
model.Administrar_FuncionalidadeCollection = model.AbstractCollection.extend({
	url: 'api/administrar_funcionalidades',
	model: model.Administrar_FuncionalidadeModel
});

/**
 * Administrar_Modulo Backbone Model
 */
model.Administrar_ModuloModel = Backbone.Model.extend({
	urlRoot: 'api/administrar_modulo',
	idAttribute: 'id',
	id: '',
	descricao: '',
	defaults: {
...
/**
 * Administrar_Modulo Backbone Collection
 */
model.Administrar_ModuloCollection = model.AbstractCollection.extend({
	url: 'api/administrar_modulos',
	model: model.Administrar_ModuloModel
});

/**
 * Administrar_Usuario Backbone Model
 */
model.Administrar_UsuarioModel = Backbone.Model.extend({
	urlRoot: 'api/administrar_usuario',
	idAttribute: 'id',
	id: '',
	nome: '',
	usuario: '',
...
/**
 * Administrar_Usuario Backbone Collection
 */
model.Administrar_UsuarioCollection = model.AbstractCollection.extend({
	url: 'api/administrar_usuarios',
	model: model.Administrar_UsuarioModel
});

/**
 * Agenda_Telefonica Backbone Model
 */
model.Agenda_TelefonicaModel = Backbone.Model.extend({
	urlRoot: 'api/agenda_telefonica',
	idAttribute: 'id',
	id: '',
	nome: '',
	telefone: '',
...
/**
 * Agenda_Telefonica Backbone Collection
 */
model.Agenda_TelefonicaCollection = model.AbstractCollection.extend({
	url: 'api/administrar_agenda',
	model: model.Agenda_TelefonicaModel
});
